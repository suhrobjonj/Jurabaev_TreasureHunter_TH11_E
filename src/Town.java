...
public class Town {
    ...
    public void lookForTreasure() {
        ...
        if (townSearched) {
            ...
            townSearched = true;
            printMessage = "You found " + treasures[treasureIndx] + "!";
        } else {
            townSearched = true;
            printMessage = "You found " + treasures[treasureIndx] + " but you already have one so you throw it away.";
        }
    }
